...
| P3 | MED-09: XFF trust model improvement | Deferred |
| P3 | LOW-04,06,08,09,11-14 | Deferred |
...
- `internal/proxy/l7/proxy.go` — Generic error messages
- `internal/proxy/l7/sse.go` — Single reader goroutine refactor
- `internal/proxy/l4/sni.go` — SNI hostname validation
- `internal/proxy/l7/proxy_test.go` — Updated test expectations
